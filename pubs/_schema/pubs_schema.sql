...
(
   ...
   pubdate        datetime          NOT NULL DEFAULT (CURDATE()),
...
(
	...
	CONSTRAINT UPKCL_jobs PRIMARY KEY CLUSTERED(job_id)
);
...
ALTER TABLE employee ADD INDEX employee_ind(lname, fname, minit);
ALTER TABLE authors ADD INDEX aunmind(au_lname, au_fname);
ALTER TABLE sales add INDEX titleidind(title_id);
ALTER TABLE titles add INDEX titleind(title);
ALTER TABLE titleauthor add INDEX auidind(au_id);
ALTER TABLE titleauthor add INDEX titleidind(title_id);
ALTER TABLE roysched add INDEX titleidind(title_id);

/* create views */
CREATE OR REPLACE VIEW titleview AS select title, au_ord, au_lname, price, ytd_sales, pub_id
...
CREATE PROCEDURE reptq3 (
	IN lolimit DECIMAL(13,2), 
    hilimit DECIMAL(13,2),
	type char(12)
)
BEGIN
	select
...
insert titles values ('PC8888', 'Secrets of Silicon Valley', 'popular_comp', '1389', 20.00, 8000.00, 10, 4095,
...
insert sales values('7131', 'N914014', '19940914', 25, 'Net 30','MC3021');
insert sales values('8042', '423LL922', '19940914', 15, 'ON invoice','MC3021');
insert sales values('8042', '423LL930', '19940914', 10, 'ON invoice','BU1032');
insert sales values('6380', '722a', '19940913', 3, 'Net 60','PS2091');
insert sales values('6380', '6871', '19940914', 5, 'Net 60','BU1032');
insert sales values('8042','P723', '19930311', 25, 'Net 30', 'BU1111');
insert sales values('7896','X999', '19930221', 35, 'ON invoice', 'BU2075');
insert sales values('7896','QQ2299', '19931028', 15, 'Net 60', 'BU7832');
insert sales values('7896','TQ456', '19931212', 10, 'Net 60', 'MC2222');
insert sales values('8042','QA879.1', '19930522', 30, 'Net 30', 'PC1035');
insert sales values('7066','A2976', '19930524', 50, 'Net 30', 'PC8888');
insert sales values('7131','P3087a', '19930529', 20, 'Net 60', 'PS1372');
insert sales values('7131','P3087a', '19930529', 25, 'Net 60', 'PS2106');
insert sales values('7131','P3087a', '19930529', 15, 'Net 60', 'PS3333');
insert sales values('7131','P3087a', '19930529', 25, 'Net 60', 'PS7777');
insert sales values('7067','P2121', '19920615', 40, 'Net 30', 'TC3218');
insert sales values('7067','P2121', '19920615', 20, 'Net 30', 'TC4203');
insert sales values('7067','P2121', '19920615', 20, 'Net 30', 'TC7777');
